      ...
      ListHeaderComponent={
        <View>
          ...
          <View style={styles.actions}>
            <Pressable accessibilityRole="button" style={styles.primary} onPress={onRegisterAnother}><Text style={styles.primaryText}>Register Another</Text></Pressable>
            <Pressable accessibilityRole="button" style={styles.secondary} onPress={onHome}><Text style={styles.secondaryText}>Back to Home</Text></Pressable>
          </View>
          <Text style={styles.label}>PARCEL TRACKING NUMBERS · {shipment.trackingIds?.length || 0}</Text>
        </View>
      }
...
const styles = StyleSheet.create({
  ...
  primary: { backgroundColor: colors.black, minHeight: 52, padding: spacing.md, justifyContent: 'center', alignItems: 'center' },
  primaryText: { color: colors.surface, fontSize: 15, fontWeight: '700' },
  secondary: { borderWidth: 1, borderColor: colors.borderStrong, minHeight: 48, padding: spacing.md, justifyContent: 'center', alignItems: 'center' },
