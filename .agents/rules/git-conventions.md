...
- The first line (subject) must remain concise and adhere to `[scope] Short description`.
...
git commit -m "[web]  Add live SSE dashboard binding"
...
git commit -m "[backend] Enforce strict waybill state transitions" \
