...
export default function DeactivateClientModal({ visible, client, onClose, onConfirm }) {
  ...
  const targetName = (client.name || '').trim().toUpperCase();
  const isMatch = typedName.trim().toUpperCase() === targetName;
  ...
  const handleDeactivate = async () => {
    ...
    try {
      ...
      setError(null);
      await onConfirm(client.clientId || client.id);
      onClose();
    } catch (err) {
      setError(err?.message || 'Failed to remove/deactivate client.');
    } finally {
      ...
      <View style={styles.backdrop}>
        <View style={styles.dialog}>
          ...
          <View style={styles.header}>
            <Text style={styles.title}>DELETE / DEACTIVATE CLIENT</Text>
          ...
          <View style={styles.body}>
            ...
            <View style={styles.warningBox}>
              <Text style={styles.warningTitle}>SMART CLIENT DELETION</Text>
              <Text style={styles.warningText}>
                Confirming will process client <Text style={styles.boldText}>{client.clientId || client.code}</Text> (
            ...
            <View style={styles.fieldGroup}>
              <Text style={styles.fieldLabel}>
                TYPE CLIENT NAME <Text style={styles.requiredTarget}>{targetName}</Text> TO CONFIRM *
              </Text>
              <TextInput
