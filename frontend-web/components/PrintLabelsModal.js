...
/**
 * Printable QR labels modal popup matching prototype register popup.png.
 */
      ...
      <View style={styles.backdrop}>
        <View style={styles.dialog}>
                  ...
                  <View style={styles.labelFooter}>
                    <View style={styles.footerRow}>
                      <Text style={styles.footerItem}>
                        ...
                        {shipment.description || 'Office Supplies'}
                      </Text>
                      <Text style={styles.footerItem}>
                        <Text style={styles.footerMuted}>Shipment: </Text>
                        <Text style={{ fontFamily: fonts.mono, fontWeight: '700' }}>{shipment.shipmentId}</Text>
                      </Text>
                    </View>
                    <View style={styles.footerRow}>
                      <Text style={styles.footerItem}>
                    ...
                    <View style={styles.totalRow}>
                      <Text style={styles.totalText}>
                        Shipment Total: ₱{Number(shipment.totalAmount || 0).toLocaleString()}
                      </Text>
                    </View>
                  </View>
                </View>
          ...
          <View style={styles.dialogActions}>
            ...
            <Button label={`Print ${count} ${count === 1 ? 'Label' : 'Labels'}`} variant="primary" onPress={handlePrint} />
          </View>
        </View>
      </View>
    </Modal>
